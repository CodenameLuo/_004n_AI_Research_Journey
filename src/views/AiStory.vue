...
示例：早上七点，被闹钟叫醒，起床洗脸刷牙。早饭吃了一个煎蛋和一杯热牛奶。我背上书包，跟小伙伴一起走路去学校。上午，在课堂上积极举手回答老师的提问。课间和同学们在走廊里玩耍。中午，在食堂吃饭，我最爱吃的米饭和西红柿炒蛋。下午体育课和同学们在操场奔跑玩耍、踢足球。放学妈妈接我回家······" 
...
// const API_BASE_URL = 'http://localhost:8100/AiStory_api'
